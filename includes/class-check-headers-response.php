...
if (false === as_next_scheduled_action('eg_midnight_log_6')) {
as_schedule_recurring_action(strtotime('now'), 5, 'eg_midnight_log_6');
}
}
...
add_action('eg_midnight_log_6', 'eg_log_action_data');

//as_unschedule_all_actions();

function unschedule_all_lc_actions() {
as_unschedule_all_actions('eg_midnight_log_6');
}
//}
